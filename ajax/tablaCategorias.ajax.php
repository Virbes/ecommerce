...
class TablaCategorias{
	...
	for($i = 0; $i < count($categorias); $i++){
			...
			$cabeceras = ControladorCabeceras::getCabeceras($valor);

			if($cabeceras['portada'] != ''){
                $imgPortada = "<img class='img-thumbnail imgPortadaCategorias' src='".$cabeceras["portada"]."' width='100px'>";
			}else{
				$imgPortada = "<img class='img-thumbnail imgPortadaCategorias' src='vistas/img/default/default.jpg' width='100px'>";
			}
