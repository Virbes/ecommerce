...
class ControladorUsuarios{
	...
	public function ctrRegistroUsuario(){
		...
		if(isset($_POST["regUsuario"])){
			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   preg_match('/^[^0-9][a-zA-Z\-0-9_]+([.][a-zA-Z\-0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["regEmail"]) &&
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$url = Ruta::ctrRuta();	
					//echo '<script>window.location = "'.$url.'verificar/'.$encriptarEmail.'"</script>';
					...
					$body = '
						<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
							<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
								...
								<center>
									<h3 style="font-weight:100; color:black">VERIFIQUE SU DIRECCIÓN DE CORREO ELECTRÓNICO</h3>
									<hr style="border:1px solid #ccc; width:80%">
									<h4 style="font-weight:100; color:black; padding:0 20px">Para comenzar a usar su cuenta de Tienda Virtual, debe confirmar su dirección de correo electrónico</h4>
									<a href="'.$url.'verificar/'.$encriptarEmail.'" target="_blank" style="text-decoration:none">
										<div style="line-height:60px; background:#FF6600; width:60%; color:white">Verifique su dirección de correo electrónico</div>
									</a>
									<br>
									<hr style="border:1px solid #ccc; width:80%">
									<h5 style="font-weight:100; color:black">Si no se inscribió en esta cuenta, puede ignorar este correo electrónico y la cuenta se eliminará.</h5>
								</center>
							</div>
						</div>';
	...
	public function ctrIngresoUsuario(){
		...
		if(isset($_POST["ingEmail"])){
			...
			if(preg_match('/^[^0-9][a-zA-Z\-0-9_]+([.][a-zA-Z\-0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["ingEmail"]) &&
				...
				if($respuesta["email"] == $_POST["ingEmail"] && $respuesta["password"] == $encriptar){
					...
					echo'<script>
							...
							swal({
								  ...
								  text: "¡Por favor revise que el email exista o la contraseña coincida!",
								  type: "error",
								  confirmButtonText: "Cerrar",
								  closeOnConfirm: false
							},
...
$key .= "";
				...
				if($respuesta1){
					...
					if($respuesta2  == "ok"){
						...
						$mail->setFrom('agnaferreteria@hotmail.com', 'Ferretería AGNA');

						$mail->addReplyTo('agnaferreteria@hotmail.com', 'Ferretería AGNA');
						...
						$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
								...
								<h3 style="font-weight:100; color:black">SOLICITUD DE NUEVA CONTRASEÑA</h3>

								<hr style="border:1px solid #ccc; width:80%">

								<h4 style="font-weight:100; color:black; padding:0 20px"><strong>Su nueva contraseña: </strong>'.$nuevaPassword.'</h4>

								<a href="'.$url.'" target="_blank" style="text-decoration:none">

								<div style="line-height:60px; background:#FF6600; width:60%; color:white">Ingrese nuevamente al sitio</div>
	...
	public static function ctrFormularioContactenos(){
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				$body ='
					<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
						<div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">
							<center>
								<h3 style="font-weight:100; color:black;">HA RECIBIDO UNA CONSULTA</h3>
								<hr style="width:80%; border:1px solid #ccc">
								<h4 style="font-weight:100; color:black; padding:0px 20px; text-transform:uppercase">'.$_POST["nombreContactenos"].'</h4>
								<h4 style="font-weight:100; color:black; padding:0px 20px;">De: '.$_POST["emailContactenos"].'</h4>
								<h4 style="font-weight:100; color:black; padding:0px 20px;">'.$_POST["telefonoContactenos"].'</h4>
								<h4 style="font-weight:100; color:black; padding:0px 20px">'.$_POST["mensajeContactenos"].'</h4>
								<hr style="width:80%; border:1px solid #ccc">
							</center>
						</div>
					</div>
				...
				require '/xampp/htdocs/admint/ecommerce/extensiones/PHPMailer/src/Exception.php';
				require '/xampp/htdocs/admint/ecommerce/extensiones/PHPMailer/src/Exception.php';
				require '/xampp/htdocs/admint/ecommerce/extensiones/PHPMailer/src/Exception.php';
