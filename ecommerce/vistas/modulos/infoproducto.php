...
if (false) {
							...
							echo '</div>
								...
								if($infoproducto["oferta"] != 0){
									...
									echo '<button class="btn btn-default btn-block btn-lg backColor agregarCarrito" stock="'.$infoproducto['stock'].'" idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precio"].'" peso="'.$infoproducto["peso"].'">';
								}
							...
							<div class="btn-group pull-right">
								...
								<button type="button" class="btn btn-default btn-xs deseos" idProducto="'.$value["id"].'" data-toggle="tooltip" title="Agregar a mi lista de deseos">
									...
									if($value["oferta"] != 0){
										...
										echo '<button type="button" class="btn btn-default btn-xs agregarCarrito" stock="'.$value['stock'].'"  idProducto="'.$value["id"].'" imagen="'.$servidor.$value["portada"].'" titulo="'.$value["titulo"].'" precio="'.$value["precio"].'" peso="'.$value["peso"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
