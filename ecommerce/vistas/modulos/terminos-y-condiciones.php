...
<div id="body-terms">
    ...
    <hr>
    <p>
        <b>SECCIÓN 1:</b> TÉRMINOS DE LA TIENDA ONLINE
    ...
    <p>
        <b>SECCIÓN 2:</b> CONDICIONES GENERALES
    ...
    <p>
        <b>SECCIÓN 3:</b> EXACTITUD, TOTALIDAD Y CRONOLOGÍA DE LA INFORMACIÓN
    ...
    <p>
        <b>SECCIÓN 4:</b> MODIFICACIONES AL SERVICIO Y PRECIOS
    ...
    <p>
        <b>SECCIÓN 5:</b> PRODUCTOS O SERVICIOS (si corresponde)
    ...
    <p>
        <b>SECCIÓN 6:</b> EXACTITUD DE LA FACTURACIÓN Y DE LA INFORMACIÓN DE LA CUENTA
    ...
    <p>
        <b>SECCIÓN 7:</b> HERRAMIENTAS OPCIONALES
    ...
    <p>
        <b>SECCIÓN 8:</b> ENLACES DE TERCEROS
    ...
    <p>
        <b>SECCIÓN 9:</b> COMENTARIOS DE LOS USUARIOS, OPINIONES Y OTRAS COMUNICACIONES
    ...
    <p>
        <b>SECCIÓN 10:</b> INFORMACIÓN PERSONAL
    ...
    <p>
        <b>SECCIÓN 11:</b> ERRORES, INEXACTITUDES Y OMISIONES
    ...
    <p>
        <b>SECCIÓN 12:</b> USOS PROHIBIDOS
    ...
    <p>
        <b>SECCIÓN 13:</b> DESCARGO DE RESPONSABILIDAD DE GARANTÍAS; LIMITACIÓN DE RESPONSABILIDAD
    ...
    <p>
        <b>SECCIÓN 17:</b> ACUERDO COMPLETO
    ...
    <p>
        <b>SECCIÓN 18:</b> LEY APLICABLE
        Los presentes Términos del servicio y cualquier acuerdo por separado por el cual le proporcionemos Servicios se regirán e interpretarán de acuerdo con las leyes de 11ª calle sur poniente, Fraccionamiento libertad., Comitán, CHIS, 30000, México.
    </p>

    <p>
        <b>SECCIÓN 19:</b> CAMBIOS EN LOS TÉRMINOS DEL SERVICIO
    ...
    <p>
        <b>SECCIÓN 20:</b> INFORMACIÓN DE CONTACTO
        Las preguntas sobre los Términos del servicio se deben enviar a francisco.virbes.457@gmail.com.
    </p>
</div>