...
if(isset($_SESSION["validarSesion"])){
	...
	if($_SESSION["validarSesion"] == "ok"){
		echo '<script>localStorage.setItem("usuario","'.$_SESSION["id"].'");</script>';
	}
				...
				if(isset($_SESSION["validarSesion"])){
					...
					if($_SESSION["validarSesion"] == "ok"){
						...
						if($_SESSION["foto"] != ""){
							...
							echo '<li>
									<img class="img-circle" src="http://localhost/admint/ecommerce/'.$_SESSION["foto"].'" width="10%">
									</li>';
...
<header class="container-fluid">
	...
	<div class="container">
		...
		<div class="row" id="cabezote">
			...
			<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12" id="buscadorx">
				...
				<div class="input-group col-lg-8 col-md-8 col-sm-8 col-xs-12" id="buscador">
					...
					<input type="search" name="buscar" class="form-control" placeholder="Código, título o descripción">	
			...
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="carrito">
				...
				<p>
					<b style="color: #686868">CARRITO</b>
					<span class="cantidadCesta"></span> <br>$ <span class="sumaCesta"></span></p>	
			</div>
					...
					<label>
						...
						<input id="regPoliticas" type="checkbox">
							...
							<small>
								...
								<br>
								<a href="https://www.iubenda.com/privacy-policy/47466395" class="iubenda-white iubenda-noiframe iubenda-embed iubenda-noiframe " title="Política de Privacidad ">Política de Privacidad</a><script type="text/javascript">(function (w,d) {var loader = function () {var s = d.createElement("script"), tag = d.getElementsByTagName("script")[0]; s.src="https://cdn.iubenda.com/iubenda.js"; tag.parentNode.insertBefore(s,tag);}; if(w.addEventListener){w.addEventListener("load", loader, false);}else if(w.attachEvent){w.attachEvent("onload", loader);}else{w.onload = loader;}})(window, document);</script>
							</small>
