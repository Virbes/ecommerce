 ...
 */
$('#enviarContactanos').click(function(e) {
	e.preventDefault();
	...
	var datosContactanos = new FormData();
		datosContactanos.append("nombre", nombre);
		datosContactanos.append("email", email);
		datosContactanos.append("telefono", telefono);
		datosContactanos.append("mensaje", mensaje);

	$.ajax({
		                
		type: 'POST', 
		url:rutaOculta+"ajax/contactanos.ajax.php",
		data: datosContactanos,
		processData: false,
		contentType: false
