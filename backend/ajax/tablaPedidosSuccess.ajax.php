...
class TablaPedidosSuccess {
 	...
 	public function mostrarTabla(){	
        ...
        $url = Ruta::ctrRuta();
 		$pedidos = ControladorPedidos::ctrMostrarPedidos(1);	
		 ...
		 for($i = 0; $i < count($pedidos); $i++){
			...
			/*=============================================
  			CREAR LAS ACCIONES
  			=============================================*/
        	$entregar = "<div class='btn-group'><button disabled class='btn btn-success btnSuccess' idPedido='".$pedidos[$i]["id"]."'><i class='fa fa-check'></i></button></div>";
...
=============================================*/ 
$activar = new TablaPedidosSuccess();
