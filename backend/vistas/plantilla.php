...
<head>
  ...
  <title>Ferre Agna | Panel de Control</title>
  ...
  <link rel="stylesheet" href="vistas/css/color.admin.css">
</head>

<body class="hold-transition skin-bve sidebar-collapse sidebar-mini login-background">
