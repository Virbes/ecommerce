  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-body">
        ...
        <table class="table table-bordered table-striped dt-responsive tablaPedidosNoEntregados" width="100%">
          <thead>
            <tr>
    ...
    <div class="box">
      <div class="box-body">
        ...
        <table class="table table-bordered table-striped dt-responsive tablaPedidosEntregados" width="100%">
          <thead>
            <tr>
              <th style="width:10px">#</th>
              <th>Imagen</th>
