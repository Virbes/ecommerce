      ...
      <div class="box-body">
        ...
        <table class="table table-bordered table-striped dt-responsive tablaPerfiles" width="100%">
          ...
          <tbody>
            ...
            $ruta_back_eco = Ruta::ctrRutaServidor();
             ...
             foreach ($perfiles as $key => $value){
                 ...
                 echo ' <tr>
                         ...
                         if($value["foto"] != ""){
                          ...
                          echo '<td><img src="'.$ruta_back_eco.$value["foto"].'" class="img-thumbnail" width="40px"></td>';

                         }else{

                            echo '<td><img src="'.$ruta_back_eco.'vistas/img/perfiles/default/anonymous.png" class="img-thumbnail" width="40px"></td>';
                 ...
                 echo '<td>'.
                     iconv('ISO-8859-2', 'UTF-8', strftime("%A, %d de %B de %Y", strtotime($value['ultimo_login']))).
                     '<br>'.
