...
/*=============================================
REVISAR SI EL CODIGO DEL PRODUCTO YA EXISTE
=============================================*/
	...
	datos.append("validarCodigo", codigo);
	 ...
	 $.ajax({
	    ...
	    success:function(respuesta){
    		...
    		if(respuesta.length != 0){
    			$(".validarCodigo").parent().after('<div class="alert alert-warning" id="alert2">El código del producto ya existe</div>');
	    		$(".validarCodigo").val("");
    		}
...
$('.tablaProductos tbody').on("click", ".btnEditarProducto", function(){
	...
	$.ajax({
		...
		success: function(respuesta){
			...
			$(".editarColor").html('<input class="form-control input-lg tagsInput detalleColor" value="'+detalles.Color+'" data-role="tagsinput" type="text" style="padding:20px">');
			$("#modalEditarProducto .detalleColor").tagsinput('items');

			$(".editarMarca").html('<input class="form-control input-lg tagsInput detalleMarca" value="'+detalles.Marca+'" data-role="tagsinput" type="text" style="padding:20px">');
...
$('.tablaProductos tbody').on("click", ".btnInfoProducto", function(){
