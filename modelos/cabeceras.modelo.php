...
class ModeloCabeceras{
	...
	static public function mdlEditarCabecera($datos){
		
		$stmt = Conexion::conectar()->prepare("UPDATE Cabeceras SET ruta = :ruta, titulo = :titulo, descripcion = :descripcion, palabrasClaves = :palabrasClaves, portada = :portada WHERE id = :id");
